...
// Needs env vars: STRIPE_SECRET_KEY, NEXT_PUBLIC_URL (or auto-detected)
...
const PRODUCTS = {
  ...
  whale:       { name: "Whale Pack",    pixels: 5000,  bonus: 1000,  price: 4999, description: "5,000 pixels + 1,000 bonus + Crown Badge for Pixels of War" },
  season_pass: { name: "Season Pass",   pixels: 50,    bonus: 0,     price: 499,  description: "Season Pass — 2× XP, +50% gold, +50 pixels, exclusive badge" },
  starter:     { name: "Starter Pack",  pixels: 100,   bonus: 0,     price: 299,  description: "100 pixels + Cluster Bomb power-up + Season Pass (3-day new player offer)" },
};

module.exports = async function handler(req, res) {
  // Allow CORS from pixelsofwar.com
  ...
  const origin = req.headers.origin || "https://www.pixelsofwar.com";
  ...
  try {
    const session = await stripe.checkout.sessions.create({
      ...
      line_items: [{
        price_data: {
          ...
          product_data: {
            ...
            images: ["https://www.pixelsofwar.com/og-image.png"],
          },
      ...
      payment_intent_data: {
        ...
        statement_descriptor_suffix: product.name.slice(0, 10).toUpperCase(),
      },
      locale: "auto",
    });
